...
Indicador visual de 3 colores en el listado de Usuarios (`user-management`) que refleja el
estado de membresía/pago de quienes tienen perfil de miembro: al día (verde), en mora (naranja) o
dado de baja (rojo, con precedencia sobre cualquier estado de pago). Quien nunca tuvo membresía
no muestra indicador. El rojo refleja el estado de membresía, no directamente el acceso — ese
bloqueo lo define `user-management` según el rol.
