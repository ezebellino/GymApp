...
`SlidersHorizontal`=Ajustar base, `Ban`=Anular/Desactivar, `RotateCcw`=Reactivar,
...
- **WHEN** el usuario ve el icon-button de "Ver", "Editar", "Reactivar", "Ajustar base" o
  "Agregar precio" en una fila
