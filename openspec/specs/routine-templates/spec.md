...
Plantillas de rutina que un Dueño o Coach arma sobre el catálogo compartido de días y ejercicios: nombre único, etiqueta corta, subconjunto ordenado de días, activación de ejercicios y su estrategia de progresión por (plantilla, día, ejercicio). Cubre también la base (series × reps · kg) de cada ejercicio del catálogo, que edita solo el Dueño, y las reglas de edición y eliminación de plantillas. Las estrategias en sí se especifican en `progression-strategies`; la asignación a Miembros, en `routine-assignment`.
