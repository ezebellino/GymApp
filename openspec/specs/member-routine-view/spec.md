...
La vista "Mi rutina" del Miembro: elegir entre las copias de rutina que le asignaron, ver solo los días de la copia elegida y, por cada ejercicio agregado a ese día, el plan calculado serie por serie (peso × repeticiones con anotaciones) según la estrategia y la base propias de esa copia. El plan no es de solo lectura: cada serie planificada ofrece la acción de marcar lo que el Miembro efectivamente hizo — ese marcado y su histórico viven en `routine-progress-tracking`.
