...
El registro de lo que el Miembro efectivamente entrenó, y su lectura por parte del staff. El Miembro marca **serie por serie y en el momento** — el peso y las repeticiones reales contra cada serie que su copia de rutina planifica — y puede corregir una marca ya hecha. Marcar es un acto de entrenamiento, no de presencia: **no registra asistencia**. El histórico es inmune a la edición de la copia: un ejercicio o un día que el Coach quita después sigue siendo consultable. Dueño y Coach ven el progreso de cualquier Miembro (histórico filtrable por ejercicio y período, más la evolución del peso por ejercicio) pero no pueden marcar por él; un Miembro solo ve y marca lo suyo.
