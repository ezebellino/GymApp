...
Flujo de invitación por link para que un usuario con rol Miembro obtenga acceso al portal.
Reemplaza al auto-registro libre (ver `register-client-view`, retirada): el alta de un Miembro y
su acceso al portal los inicia siempre un Dueño o Coach, que dispara la invitación desde la ficha
del usuario. El miembro verifica email y celular por separado antes de poder definir su
contraseña. Scopeado únicamente a rol Miembro — el alta de Dueño/Coach sigue con contraseña
seteada a mano por el admin, sin cambios.
