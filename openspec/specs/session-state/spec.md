...
Fuente única de verdad de la sesión del usuario (token de acceso, nombre y rol) para toda la app
frontend: persistencia entre recargas, disponibilidad para los guards por rol y para las llamadas
a la API, y propagación inmediata de cambios de sesión, logout y expiración de token a toda la UI.
