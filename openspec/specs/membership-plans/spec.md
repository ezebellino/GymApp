...
Planes de membresía: la categoría de cuota que se le asigna a cada miembro (General, Estudiante,
Socio del club, etc.), con nombre único, estado activo/inactivo y un historial de precios que solo
se agrega y nunca se edita ni se borra. Cubre el CRUD de planes para staff (Dueño y Coach), la
regla de que siempre debe existir al menos un plan activo, y que un plan no se puede borrar si
tiene o tuvo miembros o pagos asociados.
